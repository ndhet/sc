...
clear
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/ndhet/sc/ipuk/sstp"
...
state=Indonesia
locality=Indonesia
organization=hayosiastorevpn
organizationalunit=hayosiastorevpn
commonname=hayosiastorevpn
email=dedihaxor@gmail.com
